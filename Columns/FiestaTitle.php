 ...
 *
 */
namespace Piwik\Plugins\FiestaPlugin\Columns;
...
class FiestaTitle extends VisitDimension
{
    ...
    {
        return Piwik::translate('FiestaPlugin_FiestaTitle');
    }
    ...
    protected function configureSegments()
    {
        ...
        $segment->setName('FiestaPlugin_FiestaTitle');
    ...
    public function onNewVisit(Request $request, Visitor $visitor, $action)
    {
        ...
        return Common::getRequestVar('fiesta_title', $default=false, 'string', $request->getParams());
    }
