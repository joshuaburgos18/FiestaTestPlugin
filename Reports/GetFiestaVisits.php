 ...
 */
class GetFiestaVisits extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('FiestaPlugin_FiestaVisits');
        $this->dimension     = null;
        ...
        // $this->subcategoryId = 'FiestaPlugin_FiestaVisits';
    }
    ...
    {
        $view = new View('@FiestaPlugin/getFiestaVisits');
        $view->myData = array();
