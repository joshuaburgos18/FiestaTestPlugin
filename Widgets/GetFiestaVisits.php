 ...
 *
 */
namespace Piwik\Plugins\FiestaPlugin\Widgets;
 ...
 */
class GetFiestaVisits extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         * your own category.
         */
        $config->setCategoryId('FiestaPlugin_Fiesta');
         ...
         */
        $config->setName('FiestaPlugin_FiestaVisits');
